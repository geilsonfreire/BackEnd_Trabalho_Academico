...
router.post('/', authMiddleware, roleMiddleware('Administrador'), estoqueController.createEstoque); // Criar novo estoque (apenas Administrador)
router.put('/:id', authMiddleware, roleMiddleware('Administrador'), estoqueController.updateEstoque); // Atualizar estoque (apenas Administrador)
